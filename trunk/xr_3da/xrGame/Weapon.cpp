...
//	camDispersion		= deg2rad					(camDispersion);
	...
	// Смещение в стрейфе
	m_strafe_offset[0][0] = READ_IF_EXISTS(pSettings, r_fvector3, section, (val_name, "strafe_hud_offset_pos", _prefix), Fvector().set(0.015f, 0.f, 0.f));
	m_strafe_offset[1][0] = READ_IF_EXISTS(pSettings, r_fvector3, section, (val_name, "strafe_hud_offset_rot", _prefix), Fvector().set(0.f, 0.f, 4.5f));

	// Поворот в стрейфе
	m_strafe_offset[0][1] = READ_IF_EXISTS(pSettings, r_fvector3, section, (val_name, "strafe_aim_hud_offset_pos", _prefix), Fvector().set(0.005f, 0.f, 0.f));
	m_strafe_offset[1][1] = READ_IF_EXISTS(pSettings, r_fvector3, section, (val_name, "strafe_aim_hud_offset_rot", _prefix), Fvector().set(0.f, 0.f, 2.5f));
	...
	m_nearwall_on = READ_IF_EXISTS(pSettings, r_bool, section, "nearwall_on", true);
	if (m_nearwall_on)
	{
